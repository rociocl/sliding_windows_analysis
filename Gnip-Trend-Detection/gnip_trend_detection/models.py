...
class MannKendall:
    ...
    def get_result(self):
        ...
        return mk_test(x,self.alpha)[0], mk_test(x,self.alpha)[3]
...
class WeightedDataTemplates(object):
    ...
    def get_result(self):
        ...
        z = self.trend_weight / self.non_trend_weight

        #TODO: METODO DE DETECTAR TENDENCIAS SEGUN ETA... CAMBIAR!!!!
        if  self.trend_weight > self.non_trend_weight:
            trend = 'increasing'
        else:
            trend = 'decreasing'
...
class Poisson(object):
    ...
    def get_result(self):
        """
        Return result or figure-of-merit (eta, in this case) defined by the mode of operation and the trend analysis -> (trend, eta)
        trends:
           -1 = 'decreasing'
            0 = 'no trend'
            1 = 'increasing'
        ...
        z = s/r
        if self.last_eta == None:
            self.last_eta = z

        #TODO: METODO DE DETECTAR TENDENCIAS SEGUN ETA...
        if r and z > self.last_eta + r:
            trend = 1
        elif r and  z < self.last_eta + r and z > self.last_eta - r:
            trend = 0
        else:
            trend = -1
